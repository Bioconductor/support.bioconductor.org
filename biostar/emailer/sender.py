...
def send_mass_html_mail(subject, message, message_html, from_email, recipient_list):
    ...
    def make_email(rec):
        msg = EmailMultiAlternatives(subject=subject,
                                     body=message,
                                     from_email=from_email,
                                     to="bioconductorcoreteam+supportsite@gmail.com",
                                     bcc=[rec],
...
def send_html_mail(subject, message, message_html, from_email, recipient_list):
    ...
    Sends an HTML email.
    """
    msg = EmailMultiAlternatives(subject=subject, body=message, from_email=from_email, to="bioconductorcoreteam+supportsite@gmail.com", bcc=recipient_list)
    msg.attach_alternative(message_html, "text/html")
